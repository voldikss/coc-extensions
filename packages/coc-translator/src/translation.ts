import { TranslationResult } from './translator/defines'
import { RecordBody } from './types'

export class Translation {
  constructor(private text: string, private results: TranslationResult[]) {}

  static create(text: string, results: TranslationResult[]): Translation {
  ...
  // for history saving
  public toHistoryItem(): RecordBody | undefined {
    for (const t of this.results) {
