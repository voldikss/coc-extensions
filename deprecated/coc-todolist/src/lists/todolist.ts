import { BasicList, ListAction, ListItem, Neovim, window, workspace } from 'coc.nvim'
...
export default class TodoList extends BasicList {
  ...
  public doHighlight(): void {
    ...
    nvim.command(
      'syn match CocTodolistDescription /.*/ contains=CocTodolistStatus,CocTodolistTopic',
      true,
    )
